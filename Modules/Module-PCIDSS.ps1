...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 1 -- Network Security Controls..." -ForegroundColor Yellow
    ...
    try {
        ...
        if ($null -ne $fwDomain -and $fwDomain.Enabled -eq $true) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='1.2.1'; NIST='SC-7'; ISO27001='A.8.20'; CIS='9.1.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Error" `
            -Message "1.2.1a: Firewall enabled -- Domain profile -- check failed: $_" `
            -Severity "High" `
            -CrossReferences @{ PCIDSS='1.2.1'; NIST='SC-7' }
    }
    ...
    try {
        ...
        if ($null -ne $fwPrivate -and $fwPrivate.Enabled -eq $true) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='1.2.1'; NIST='SC-7'; CIS='9.2.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $fwPublic -and $fwPublic.Enabled -eq $true) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='1.2.1'; NIST='SC-7'; CIS='9.3.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $fwDomain -and $fwDomain.DefaultInboundAction -eq "Block") {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='1.2.1'; NIST='SC-7(5)'; CIS='9.1.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Error" `
            ...
            -Severity "High" `
            -CrossReferences @{ PCIDSS='1.2.1'; NIST='SC-7(5)' }
    }
    ...
    try {
        ...
        if ($null -ne $fwPublic -and $fwPublic.DefaultInboundAction -eq "Block") {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='1.2.1'; NIST='SC-7(5)'; CIS='9.3.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='1.2.5'; NIST='AC-17'; CIS='18.9.65.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Warning" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='1.3.1'; NIST='CM-7'; ISO27001='A.8.9'; STIG='V-220968' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='1.3.2'; NIST='SC-20'; CIS='18.5.4.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 2) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='1.3.3'; NIST='SC-7'; CIS='18.4.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 2) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='1.3.4'; NIST='SC-7'; CIS='18.4.3' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='1.3.5'; NIST='SC-7'; CIS='18.4.4' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='1.4.1'; NIST='SC-8'; CIS='2.3.9.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='1.4.2'; NIST='SC-8'; CIS='2.3.9.5' }
        } else {
            Add-Result -Category "PCIDSS - Req 1 Network Security" -Status "Fail" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 2 -- Secure Configuration..." -ForegroundColor Yellow
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='2.2.1'; NIST='AC-6'; ISO27001='A.5.15'; STIG='V-220926' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Error" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 255) {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='2.2.1'; NIST='MP-7'; CIS='18.9.8.3' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val) {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='2.2.2'; NIST='AC-2'; CIS='1.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Warning" `
    ...
    try {
        ...
        if ($null -ne $guestAcct -and $guestAcct.Enabled -eq $false) {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='2.2.2'; NIST='AC-2'; ISO27001='A.5.18' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Error" `
            ...
            -Severity "High" `
            -CrossReferences @{ PCIDSS='2.2.2'; NIST='AC-2' }
    }
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='2.2.3'; NIST='IA-5'; CIS='2.3.11.5' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -ge 5) {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='2.2.4'; NIST='IA-2'; CIS='2.3.11.7'; STIG='V-220968' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='2.2.5'; NIST='IA-5(13)'; CIS='18.3.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='2.2.5'; NIST='IA-5(13)'; CIS='18.3.6' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='2.2.6'; NIST='CM-6'; CIS='18.9.100.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
    ...
    try {
        ...
        if ($null -eq $svc -or $svc.Status -ne "Running") {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='2.2.7'; NIST='CM-7'; CIS='5.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
    ...
    try {
        ...
        if ($null -eq $svc -or $svc.Status -ne "Running") {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Pass" `
                ...
                -Severity "Low" `
                -CrossReferences @{ PCIDSS='2.2.7'; NIST='CM-7' }
        } else {
            Add-Result -Category "PCIDSS - Req 2 Secure Config" -Status "Fail" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 3 -- Protect Stored Account Data..." -ForegroundColor Yellow
    ...
    try {
        ...
        if ($null -ne $blStatus -and $blStatus.ProtectionStatus -eq "On") {
            Add-Result -Category "PCIDSS - Req 3 Stored Data" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='3.4.1'; NIST='SC-28'; ISO27001='A.8.24' }
        } elseif ($null -ne $blStatus) {
            Add-Result -Category "PCIDSS - Req 3 Stored Data" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 3 Stored Data" -Status "Error" `
            -Message "3.4.1: Encryption at rest -- BitLocker status -- check failed: $_" `
            -Severity "Critical" `
            -CrossReferences @{ PCIDSS='3.4.1'; NIST='SC-28' }
    }
    ...
    try {
        ...
        if ($null -ne $val -and $val -ge 7) {
            Add-Result -Category "PCIDSS - Req 3 Stored Data" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='3.4.2'; NIST='SC-13'; CIS='18.10.9.1.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 3 Stored Data" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 3 Stored Data" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='3.5.1'; NIST='SC-4'; CIS='2.3.11.9' }
        } else {
            Add-Result -Category "PCIDSS - Req 3 Stored Data" -Status "Fail" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 4 -- Strong Cryptography in Transit..." -ForegroundColor Yellow
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 4 Crypto Transit" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='4.2.1'; NIST='SC-8'; ISO27001='A.8.24' }
        } else {
            Add-Result -Category "PCIDSS - Req 4 Crypto Transit" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 4 Crypto Transit" -Status "Error" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 4 Crypto Transit" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='4.2.2'; NIST='SC-13'; ISO27001='A.8.24' }
        } else {
            Add-Result -Category "PCIDSS - Req 4 Crypto Transit" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 4 Crypto Transit" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='4.2.3'; NIST='IA-2'; CIS='18.9.102.1.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 4 Crypto Transit" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 4 Crypto Transit" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='4.2.4'; NIST='SC-8'; CIS='18.9.102.1.3' }
        } else {
            Add-Result -Category "PCIDSS - Req 4 Crypto Transit" -Status "Fail" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 5 -- Protect Against Malware..." -ForegroundColor Yellow
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='5.2.1'; NIST='SI-3'; ISO27001='A.8.7'; CIS='18.9.47.9.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Error" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='5.2.1'; NIST='SI-3'; CIS='18.9.47.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $svc -and $svc.Status -eq "Running") {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='5.2.1'; NIST='SI-3'; CISA='EDR' }
        } else {
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='5.2.2'; NIST='SI-3'; CIS='18.9.47.9.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 2) {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='5.2.3'; NIST='SI-3(10)'; CIS='18.9.47.11.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='5.2.4'; NIST='SI-3'; CIS='18.9.47.9.3' }
        } else {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -ge 1) {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='5.2.5'; NIST='SI-3'; CIS='18.9.47.15' }
        } else {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='5.3.1'; NIST='SI-3'; CIS='18.9.47.12.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='5.3.2'; NIST='SI-3'; CIS='18.9.47.5.1.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 5 Malware" -Status "Fail" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 6 -- Develop and Maintain Secure Systems..." -ForegroundColor Yellow
    ...
    try {
        ...
        if ($null -ne $val -and $val -ge 4) {
            Add-Result -Category "PCIDSS - Req 6 Secure Systems" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='6.3.1'; NIST='SI-2'; ISO27001='A.8.8'; CISA='Patch Management' }
        } else {
            Add-Result -Category "PCIDSS - Req 6 Secure Systems" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 6 Secure Systems" -Status "Error" `
    ...
    try {
        ...
        if ($null -ne $svc -and $svc.Status -eq "Running") {
            Add-Result -Category "PCIDSS - Req 6 Secure Systems" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='6.3.2'; NIST='SI-2'; CISA='Patch Management' }
        } else {
            $svcSt = if ($null -ne $svc) { $svc.Status } else { "Not Found" }
            Add-Result -Category "PCIDSS - Req 6 Secure Systems" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -ne 0) {
            Add-Result -Category "PCIDSS - Req 6 Secure Systems" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='6.3.3'; NIST='SI-16'; CIS='18.3.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 6 Secure Systems" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val) {
            Add-Result -Category "PCIDSS - Req 6 Secure Systems" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='6.3.4'; NIST='SI-16'; CIS='18.3.3' }
        } else {
            Add-Result -Category "PCIDSS - Req 6 Secure Systems" -Status "Warning" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 7 -- Restrict Access by Business Need..." -ForegroundColor Yellow
    ...
    try {
        ...
        if ($adminCount -le 2) {
            Add-Result -Category "PCIDSS - Req 7 Access Control" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='7.1.1'; NIST='AC-6'; ISO27001='A.5.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 7 Access Control" -Status "Warning" `
        ...
        Add-Result -Category "PCIDSS - Req 7 Access Control" -Status "Error" `
            -Message "7.1.1: Least privilege -- admin account count -- check failed: $_" `
            -Severity "High" `
            -CrossReferences @{ PCIDSS='7.1.1'; NIST='AC-6' }
    }
    ...
    try {
        ...
        if ($null -ne $val -and $val -ge 1) {
            Add-Result -Category "PCIDSS - Req 7 Access Control" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='7.2.1'; NIST='AC-14'; CIS='2.3.10.6' }
        } else {
            Add-Result -Category "PCIDSS - Req 7 Access Control" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 7 Access Control" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='7.2.2'; NIST='AC-14'; CIS='2.3.10.7' }
        } else {
            Add-Result -Category "PCIDSS - Req 7 Access Control" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 7 Access Control" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='7.2.3'; NIST='AC-14'; STIG='V-220936' }
        } else {
            Add-Result -Category "PCIDSS - Req 7 Access Control" -Status "Fail" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 8 -- Identify Users and Authenticate Access..." -ForegroundColor Yellow
    ...
    try {
        ...
        if ($minLen -ge 12) {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='8.3.6'; NIST='IA-5'; CIS='1.1.4'; ISO27001='A.5.17' }
        } else {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Error" `
            -Message "8.3.1: Password length -- minimum 12 characters -- check failed: $_" `
            -Severity "High" `
            -CrossReferences @{ PCIDSS='8.3.6'; NIST='IA-5' }
    }
    ...
    try {
        ...
        if ($lockThresh -gt 0 -and $lockThresh -le 10) {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='8.3.4'; NIST='AC-7'; CIS='1.2.1'; ISO27001='A.5.17' }
        } else {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Error" `
            ...
            -Severity "High" `
            -CrossReferences @{ PCIDSS='8.3.4'; NIST='AC-7' }
    }
    ...
    try {
        ...
        if ($lockDur -ge 30) {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='8.3.5'; NIST='AC-7'; CIS='1.2.2' }
        } else {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Error" `
            ...
            -Severity "Medium" `
            -CrossReferences @{ PCIDSS='8.3.5'; NIST='AC-7' }
    }
    ...
    try {
        ...
        if ($pwHist -ge 4) {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='8.3.7'; NIST='IA-5(1)'; CIS='1.1.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Error" `
            ...
            -Severity "Medium" `
            -CrossReferences @{ PCIDSS='8.3.7'; NIST='IA-5(1)' }
    }
    ...
    try {
        ...
        if ($null -ne $val -and $val -le 900) {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='8.3.9'; NIST='AC-12'; CIS='2.3.7.3' }
        } else {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -le 900000) {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='8.3.9'; NIST='AC-12'; CIS='18.9.65.3.10.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='8.3.10'; NIST='AC-17'; CIS='18.9.65.3.9.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 0) {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='8.3.11'; NIST='IA-5' }
        } else {
            Add-Result -Category "PCIDSS - Req 8 Authentication" -Status "Fail" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 10 -- Log and Monitor All Access..." -ForegroundColor Yellow

    # 10.2.1a: Audit capability -- Event Log service running
    try {
        $svc = Get-Service -Name "EventLog" -ErrorAction SilentlyContinue
        if ($null -ne $svc -and $svc.Status -eq "Running") {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='10.2.1'; NIST='AU-2'; ISO27001='A.8.15' }
        } else {
            $svcSt = if ($null -ne $svc) { $svc.Status } else { "Not Found" }
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Error" `
    ...
    try {
        ...
        if ($logonAudit) {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='10.2.1'; NIST='AU-2'; CIS='17.5.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Error" `
            ...
            -Severity "Critical" `
            -CrossReferences @{ PCIDSS='10.2.1'; NIST='AU-2' }
    }
    ...
    try {
        ...
        if ($acctAudit) {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='10.2.2'; NIST='AU-2'; CIS='17.1.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Error" `
            ...
            -Severity "High" `
            -CrossReferences @{ PCIDSS='10.2.2'; NIST='AU-2' }
    }
    ...
    try {
        ...
        if ($objAudit) {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='10.2.3'; NIST='AU-12'; CIS='17.6.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Warning" `
        ...
        Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Error" `
            ...
            -Severity "High" `
            -CrossReferences @{ PCIDSS='10.2.3'; NIST='AU-12' }
    }
    ...
    try {
        ...
        if ($polAudit) {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "Critical" `
                -CrossReferences @{ PCIDSS='10.2.4'; NIST='AU-12'; CIS='17.7.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Error" `
            ...
            -Severity "Critical" `
            -CrossReferences @{ PCIDSS='10.2.4'; NIST='AU-12' }
    }
    ...
    try {
        ...
        if ($privAudit) {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='10.2.5'; NIST='AU-12'; CIS='17.8.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Warning" `
        ...
        Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Error" `
            ...
            -Severity "High" `
            -CrossReferences @{ PCIDSS='10.2.5'; NIST='AU-12' }
    }
    ...
    try {
        ...
        if ($secLogSize -ge 1073741824) {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='10.3.1'; NIST='AU-4'; ISO27001='A.5.28' }
        } else {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Error" `
            ...
            -Severity "High" `
            -CrossReferences @{ PCIDSS='10.3.1'; NIST='AU-4' }
    }
    ...
    try {
        ...
        if ($appLogSize -ge 268435456) {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='10.3.2'; NIST='AU-4'; CIS='18.9.27.1.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Warning" `
        ...
        Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Error" `
            ...
            -Severity "Medium" `
            -CrossReferences @{ PCIDSS='10.3.2'; NIST='AU-4' }
    }
    ...
    try {
        ...
        if ($null -ne $svc -and $svc.Status -eq "Running") {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='10.6.1'; NIST='AU-8'; CIS='18.5.14.1' }
        } else {
            $svcSt = if ($null -ne $svc) { $svc.Status } else { "Not Found" }
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='10.5.1'; NIST='AU-12'; CIS='18.9.100.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 10 Logging" -Status "Fail" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 11 -- Test Security of Systems and Networks Regularly..." -ForegroundColor Yellow

    # 11.3.1: Vulnerability scanning readiness -- Windows Update
    try {
        $svc = Get-Service -Name "wuauserv" -ErrorAction SilentlyContinue
        if ($null -ne $svc -and $svc.Status -eq "Running") {
            Add-Result -Category "PCIDSS - Req 11 Testing" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='11.3.1'; NIST='RA-5' }
        } else {
            $svcSt = if ($null -ne $svc) { $svc.Status } else { "Not Found" }
            Add-Result -Category "PCIDSS - Req 11 Testing" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 11 Testing" -Status "Error" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -eq 1) {
            Add-Result -Category "PCIDSS - Req 11 Testing" -Status "Pass" `
                ...
                -Severity "High" `
                -CrossReferences @{ PCIDSS='11.5.1'; NIST='SI-4'; CIS='18.9.47.5.3.1' }
        } else {
            Add-Result -Category "PCIDSS - Req 11 Testing" -Status "Fail" `
...
# ===========================================================================
Write-Host "[PCIDSS] Checking Req 12 -- Support Information Security with Policies and Programs..." -ForegroundColor Yellow
    ...
    try {
        ...
        if ($null -ne $val -and $val -ne "") {
            Add-Result -Category "PCIDSS - Req 12 Policies" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='12.1.1'; NIST='AC-8'; ISO27001='A.5.10' }
        } else {
            Add-Result -Category "PCIDSS - Req 12 Policies" -Status "Fail" `
        ...
        Add-Result -Category "PCIDSS - Req 12 Policies" -Status "Error" `
    ...
    try {
        ...
        if ($null -ne $val -and $val -ne "") {
            Add-Result -Category "PCIDSS - Req 12 Policies" -Status "Pass" `
                ...
                -Severity "Low" `
                -CrossReferences @{ PCIDSS='12.1.2'; NIST='AC-8'; CIS='2.3.7.4' }
        } else {
            Add-Result -Category "PCIDSS - Req 12 Policies" -Status "Fail" `
    ...
    try {
        ...
        if ($null -ne $svc -and $svc.Status -eq "Running") {
            Add-Result -Category "PCIDSS - Req 12 Policies" -Status "Pass" `
                ...
                -Severity "Medium" `
                -CrossReferences @{ PCIDSS='12.10.1'; NIST='IR-4'; SOC2='CC7.3' }
        } else {
            $svcSt = if ($null -ne $svc) { $svc.Status } else { "Not Found" }
            Add-Result -Category "PCIDSS - Req 12 Policies" -Status "Info" `
...
Write-Host "  [PCIDSS] PCI DSS v4.0 Module Complete (v$moduleVersion)" -ForegroundColor Cyan
...
if ($MyInvocation.ScriptName -eq "" -or $MyInvocation.ScriptName -eq $MyInvocation.MyCommand.Path) {
    ...
    Write-Host "[PCIDSS] Executing checks with standalone environment...`n" -ForegroundColor Cyan
    $script:results = @()
    ...
    Write-Host "`n$("=" * 80)" -ForegroundColor White
    Write-Host "  PCIDSS module standalone test complete" -ForegroundColor Cyan
    Write-Host "  All $($results.Count) checks executed" -ForegroundColor Cyan
    Write-Host "$("=" * 80)`n" -ForegroundColor White
}

# ============================================================================
# End of PCIDSS Windows Security Baseline Module (Module-PCIDSS.ps1)
# ============================================================================
